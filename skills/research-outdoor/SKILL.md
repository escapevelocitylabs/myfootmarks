...
Read `.myfootmarks/current-trip` to get the slug. Read `Trips/<slug>/trip.yaml` and parse it. Extract `destination`, `start_date`, `end_date`, `travelers`, `regions`, `interests`.
